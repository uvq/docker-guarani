...
RUN apt-get update -y && apt-get install postgresql-client-9.4 -y && apt-get install fop -y && apt-get install libfreetype6 libfreetype6-dev -y && apt-get install php5-pgsql -y && apt-get install libpq-dev -y
